...
/**
 *  @file
 *  @brief QNN HTP MCP Profile component API.
 *
 *          Requires HTP MCP backend to be initialized.
 *          Should be used with the QnnProfile API but has HTP MCP backend
 *          specific definition for different QnnProfile data structures
 *
 */

#ifndef QNN_HTP_MCP_PROFILE_H
#define QNN_HTP_MCP_PROFILE_H
 ...
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_CONTEXT_LOAD_BIN_HOST_RPC_TIME_MICROSEC 1002
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_CONTEXT_LOAD_BIN_HTP_RPC_TIME_MICROSEC 1003
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_CONTEXT_LOAD_BIN_ACCEL_TIME_MICROSEC 1004
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_HOST_RPC_TIME_MICROSEC 2001
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_HTP_RPC_TIME_MICROSEC 2002
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_ACCEL_TIME_MICROSEC 2003
 ...
 * @note HTP_MCP Performance Estimates maybe available on both
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE 2004
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_MODE 2005
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_SIM_EXEC_CYCLES 2006
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_SIM_EXEC_LOWER_CYCLES 2007
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_SIM_EXEC_UPPER_CYCLES 2008
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_BANDWIDTH_STATS 2009
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_BANDWIDTH_STATS_HTP_ID 2010
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_INPUT_FILL 2011
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_INTERMEDIATE_FILL 2012
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_INTERMEDIATE_SPILL 2013
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_INTER_HTP_FILL 2014
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_INTER_HTP_SPILL 2015
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_FINALIZE_PERF_ESTIMATE_OUTPUT_SPILL 2016
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_HOST_RPC_TIME_MICROSEC 3001
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_HTP_RPC_TIME_MICROSEC 3002
 ...
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_ACCEL_TIME_CYCLE 3003
 ...
 *       There will be a sub-event for each node that was added to the graph
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_ACCEL_TIME_MICROSEC 3004
 ...
 *       QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_MISC_ACCEL_TIME_MICROSEC 3005
 ...
 *        The value returned is time taken in microseconds.
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_YIELD_INSTANCE_RELEASE_TIME 3006
 ...
 *        The value returned is time taken in microseconds
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_YIELD_INSTANCE_WAIT_TIME 3007
 ...
 *        The value returned is time taken in microseconds
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_YIELD_INSTANCE_RESTORE_TIME 3008
 ...
 *        during execution
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_YIELD_COUNT 3009
 ...
 *        The value returned is time taken in microseconds.
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_VTCM_ACQUIRE_TIME 3010
 ...
 *        The value returned is time taken in microseconds.
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_RESOURCE_POWER_UP_TIME 3011
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_DEINIT_HOST_RPC_TIME_MICROSEC 4001
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_DEINIT_HTP_RPC_TIME_MICROSEC 4002
 ...
 *       QNN_PROFILE_LEVEL_BASIC and QNN_PROFILE_LEVEL_DETAILED levels
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_DEINIT_ACCEL_TIME_MICROSEC 4003
 ...
 *
 * @note node wait information is available on QNN_HTP_MCP_PROFILE_LEVEL_LINTING level
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_NODE_WAIT 5001
 ...
 *
 * @note node overlap information is available on QNN_HTP_MCP_PROFILE_LEVEL_LINTING level
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_NODE_OVERLAP 5002
 ...
 *
 * @note node wait overlap information is available on QNN_HTP_MCP_PROFILE_LEVEL_LINTING
 *       level
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_NODE_WAIT_OVERLAP 5003
 ...
 *        an op uses.
 *
 * @note node specific information is available on QNN_HTP_MCP_PROFILE_LEVEL_LINTING level
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_NODE_RESOURCEMASK 5004
 ...
 * @note node specific information is available on QNN_HTP_MCP_PROFILE_LEVEL_LINTING level
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_NODE_CRITICAL_BG_OP_ID 5005
 ...
 * @note node specific information is available on QNN_HTP_MCP_PROFILE_LEVEL_LINTING level
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_NODE_WAIT_BG_OP_ID 5006
 ...
 *
 * @note graph execute accelerator time maybe available only on
 *       QNN_HTP_MCP_PROFILE_LEVEL_LINTING levels
 *
 * @note When QNN_HTP_MCP_PROFILE_LEVEL_LINTING is used, this event can have
 *       multiple sub-events of type QNN_PROFILE_EVENTTYPE_NODE.
 *       There will be a sub-event for each node that was added to the graph
 */
#define QNN_HTP_MCP_PROFILE_EVENTTYPE_GRAPH_EXECUTE_CRITICAL_ACCEL_TIME_CYCLE 6001
 ...
 */
#define QNN_HTP_MCP_PROFILE_LEVEL_LINTING 7001
